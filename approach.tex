...
We randomly initialize them with uniform samples from $\left[-\sqrt{\frac{6}{r+c}}, +\sqrt{\frac{6}{r+c}}}~\right]$, $r$ and $c$ are the number of the rows and columns, following Glorot and Bengio (2010).
